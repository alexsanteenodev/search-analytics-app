...
use App\Http\Controllers\Curl\RollingCurl;
...
class AngryCurl extends RollingCurl {
    ...
    function __construct($callback = null, $debug_log = false)
    {
        ...
        {
            throw new \HttpException("(!) cURL is not enabled");
        }
    ...
    public function request($url, $method = "GET", $post_data = null, $headers = null, $options = null)
    {
        ...
        {
            throw new \HttpException("(!) Option 'use_proxy_list' is set, but no alive proxy available");
        }
        ...
        {
            throw new \HttpException("(!) Option 'use_useragent_list' is set, but no useragents available");
        }
    ...
    public function execute($window_size = null)
    {
        ...
        {
            throw new \HttpException(" (!) Wrong threads amount in execute():\t$window_size");
        }
    ...
    public function load_useragent_list($input)
    {
        ...
        {
            throw new \HttpException("# (!) No useragents loaded");
        }
    ...
    public function load_proxy_list($input, $window_size = 5, $proxy_type = 'http', $proxy_test_url = 'http://google.com', $proxy_valid_regexp = null)
    {
        ...
        {
            throw new \HttpException(" (!) Wrong threads amount in load_proxy_list():\t$window_size");
        }
        ...
        {
            throw new HttpException(200, " (!) Proxies amount < 0 in load_proxy_list():\t{$this->n_proxy}");
        }
    ...
    protected function filter_alive_proxy($window_size = 5)
    {
        ...
        if( intval($window_size) < 1 || !is_int($window_size) )
        {
            throw new \HttpException(" (!) Wrong threads amount in filter_alive_proxy():\t$window_size");
        }
